...
require '../Common/nepali_date.php'; // your helper file
...
// Build SQL
$sql = "SELECT * FROM advance_payment WHERE outlet_id = ?";
...
<title>Advance Payments - <?php echo htmlspecialchars($outlet_name); ?></title>
        ...
        <table>
            ...
            <?php foreach($payments as $i => $p): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($p['fiscal_year']); ?></td>
                    <td><?php echo htmlspecialchars($p['school_name']); ?></td>
                    <td><?php echo htmlspecialchars($p['customer_name']); ?></td>
                    <td><?php echo number_format($p['advance_amount'],2); ?></td>
                    <td><?php echo htmlspecialchars($p['payment_method']); ?></td>
                    <td><?php echo htmlspecialchars($p['printed_by']); ?></td>
                    <td><?php echo htmlspecialchars($p['bs_datetime']); ?></td>
                    <td>
                        <?php 
